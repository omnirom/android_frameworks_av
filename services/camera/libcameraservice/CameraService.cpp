...
Status CameraService::connectHelper(const sp<CALLBACK>& cameraCb, const String8& cameraId,
    ...
    if (camId.compare("1") == 0 && (property_get("sys.camera.motor.direction", direction, NULL) != 2)) {
...
binder::Status CameraService::BasicClient::disconnect() {
    ...
    if (camId.compare("1") == 0 && (property_get("sys.camera.motor.direction", direction, NULL) != 4)) {
